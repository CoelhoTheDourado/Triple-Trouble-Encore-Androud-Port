...
local move = 20; -- how much it moves before going the other direction
...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 200) * (bpm / 200) --this is basically speed, idk how to adjust it

    if curStep >= 2944 and curStep < 4223 then
        for i = 0,7 do --the amount of notes like 0,7 is all, 0.3 is all opponent and 4,7 is all player. to do single just 0,0
            ...
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + move * math.cos((currentBeat + i*0.25) * math.pi))
    ...
    if curStep == 4223 then --this is to revert back to original position
        for i = 0,7 do 
