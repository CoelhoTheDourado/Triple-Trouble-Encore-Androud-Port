...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 165) * (bpm / 165) --this is basically speed, idk how to adjust it

    if curStep >= 1376 and curStep < 1408 then
    ...
    if curStep == 1408 then --this is to revert back to original position
        for i = 0,7 do 
