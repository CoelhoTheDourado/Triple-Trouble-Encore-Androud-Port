...
local move = 30; -- how much it moves before going the other direction
...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 140) * (bpm / 140) --this is basically speed, idk how to adjust it

    if curStep >= 1424 and curStep < 1680 then
    ...
    if curStep == 1680 then --this is to revert back to original position
        for i = 0,7 do 
